...
class TimeStamp {
    static byte[] getRequest(byte[] data) throws Exception {
    ...
    static TimeStampResponse getResponse(byte[] request, String tsGeneratorUrl) throws Exception {
...
static void addTsElements(Document doc, String tsToken, Node qualifProps) {
